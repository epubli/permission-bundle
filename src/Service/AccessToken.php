...
class AccessToken
{
    ...
    private function addPermissionKeysOfRole(): void
    {
        if ($this->roleId === null) {
            return;
        }
        ...
        try {
            $response = $this->client->get(
                str_replace('{role_id}', $this->roleId, $this->path),
                [
    ...
    /**
     * This can be null even if the token exists.
     * In this case this is not a user but a token generated by a microservice
     * to access resources for itself.
     * @return int|null
     */
